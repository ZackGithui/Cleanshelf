...
fun SignUp(
    ...
    Column(
        ...
        CleanShelfTextField(
            ...
            onValueChange = { viewModel.uiEvents(SignUpEvents.UserNameChanged(it)) },
        ...
        CleanShelfTextField(
            ...
            onValueChange = { viewModel.uiEvents(SignUpEvents.UserEmailChanged(it)) },
            placeholder = "Email"
        )
        Spacer(modifier = Modifier.height(20.dp))
        CleanShelfPasswordTextField(
            value = signUpState.value.password,
            onValueChange = { viewModel.uiEvents(SignUpEvents.UserPasswordChanged(it)) },
            onTrailingIconClicked = { viewModel.uiEvents(SignUpEvents.VisibilityToggled) },
        ...
        CleanShelfLabelButton(
            ...
            clickableText = "LogIn",
            onClick = {viewModel.uiEvents(SignUpEvents.SignInLabelClicked)}
        )
        Spacer(modifier = Modifier.height(20.dp))
        CleanShelfButton(
            modifier = modifier
                .fillMaxWidth(),
            title = "Sign Up",
            onClick = {viewModel.uiEvents(SignUpEvents.SignUpButtonClicked)}
