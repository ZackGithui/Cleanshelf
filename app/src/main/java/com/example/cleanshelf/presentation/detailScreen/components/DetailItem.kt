            ...
            Column(modifier = Modifier.padding(horizontal = 15.dp)
                ...
                Row(
                    ...
                    Text(
                        ...
                        style = MaterialTheme.typography.bodyLarge.copy(fontSize = 23.sp).copy(color = MaterialTheme.colorScheme.onBackground)
                    )
                ...
                Text(
                    ...
                    style = MaterialTheme.typography.bodyLarge.copy(fontSize = 20.sp).copy(color = MaterialTheme.colorScheme.onBackground)
                )
                Spacer(modifier = Modifier.height(10.dp))

                Text(
                    text = productResponseItem.description,
                    style = MaterialTheme.typography.bodyLarge.copy(fontSize = 19.sp).copy(color = MaterialTheme.colorScheme.onBackground)
                )
                Spacer(modifier = Modifier.height(20.dp))
